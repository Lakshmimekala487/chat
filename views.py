...
def login_view(request):
    ...
    # Retrieve user profile and profile picture if user is authenticated
    user_profile = None
    ...
    return render(request, 'login.html', {'form': form, 'user_profile': user_profile, 'profile_picture': profile_picture})
...
def Forgetpassword(request):
    ...
    return render(request,'registration/Forgetpassword.html',{'form':emptyForm}) 